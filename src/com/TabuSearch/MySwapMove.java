...
public class MySwapMove implements ComplexMove {
	...
	public MySwapMove( Instance instance, Customer customer, int deleteRouteNr, int deletePositionIndex,  int insertRouteNr)
	{   
	...
	private void evaluateTotalCostVariation(MySolution sol, MySwapMove move, Cost initialInsertCost, Cost initialDeleteCost) 
	{
